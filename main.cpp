...
/* A basic application to test our filters. The application of a filter depeneds on the arguments we give to the CMD.
   We created it in a such way that it works whether we run it from the CMD or we just click on the .exe program.
*/
using namespace std;
using namespace math;

int main(int argc, char *argv[]) {
	string filename;	//Name of the image
	string input;	   //User input (used for the .exe functionality
	//The names of the 4 filters
	string blank = " ";
	...
	Image * image = new Image(); //Creating an Image using a pointer
